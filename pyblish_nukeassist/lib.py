...
def setup(console=False, port=None, menu=True):
    ...
    print("pyblish-nukeassist: Loaded successfully.")
...
def register_host():
    ...
    pyblish.api.register_host("nukeassist")


def deregister_host():
    """De-register supported hosts"""
    pyblish.api.deregister_host("nukeassist")
...
class pyblish_nuke_dockwidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.setObjectName("pyblish_nukeassist.dock")
...
def dock(window):
    ...
    widget_path = "pyblish_nukeassist.lib.pyblish_nukeassist_dockwidget"
    panel = nukescripts.panels.registerWidgetAsPanel(widget_path,
                                                     window.windowTitle(),
                                                     "pyblish_nukeassist.dock",
                                                     True).addToPane(pane)
